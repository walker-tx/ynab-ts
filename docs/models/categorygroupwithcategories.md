...
| `categories`                                                                                                            | [models.Category](../models/category.md)[]                                                                              | :heavy_check_mark:                                                                                                      | Category group categories.  Amounts (assigned, activity, available, etc.) are specific to the current plan month (UTC). |