 ...
 */
export function transactionsListByAccount(
  client: YnabCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetTransactionsByAccountRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetTransactionsByAccountResponse$inboundSchema),
    M.jsonErr(404, errors.ErrorResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
      "default",
      operations.GetTransactionsByAccountResponse$inboundSchema,
    ),
