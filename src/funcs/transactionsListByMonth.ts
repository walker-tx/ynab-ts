 ...
 */
export function transactionsListByMonth(
  client: YnabCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetTransactionsByMonthRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    month: encodeSimple("month", payload.month, {
      explode: false,
      charEncoding: "percent",
    }),
  };

  const path = pathToFunc("/budgets/{budget_id}/months/{month}/transactions")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetTransactionsByMonthResponse$inboundSchema),
    M.jsonErr(404, errors.ErrorResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetTransactionsByMonthResponse$inboundSchema),
