 ...
 */
export function scheduledTransactionsUpdate(
  client: YnabCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateScheduledTransactionRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.PutScheduledTransactionWrapper, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ScheduledTransactionResponse$inboundSchema),
