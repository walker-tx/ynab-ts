 ...
 */
export function monthsGetPlanMonths(
  client: YnabCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetPlanMonthsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/plans/{plan_id}/months")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.MonthSummariesResponse$inboundSchema),
