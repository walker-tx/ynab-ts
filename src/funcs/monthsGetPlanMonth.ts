 ...
 */
export function monthsGetPlanMonth(
  client: YnabCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetPlanMonthRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/plans/{plan_id}/months/{month}")(pathParams);
