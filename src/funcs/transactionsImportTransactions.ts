 ...
 */
export function transactionsImportTransactions(
  client: YnabCore,
...
> {
  ...
  const path = pathToFunc("/plans/{plan_id}/transactions/import")(pathParams);
  ...
  const doResult = await client._do(req, {
    ...
    isErrorStatusCode: (statusCode: number) =>
      !matchStatusCode({ status: statusCode } as Response, ["200", "201"]),
