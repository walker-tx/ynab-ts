 ...
 */
export function payeeLocationsGetPayeeLocationsByPayee(
  client: YnabCore,
...
> {
  ...
  const path = pathToFunc("/plans/{plan_id}/payees/{payee_id}/payee_locations")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PayeeLocationsResponse$inboundSchema),
