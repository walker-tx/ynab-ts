 ...
 */
export function budgetsGetSettings(
  client: YnabCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetBudgetSettingsByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/budgets/{budget_id}/settings")(pathParams);
