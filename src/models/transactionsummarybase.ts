 ...
 */
export const TransactionSummaryBaseDebtTransactionType = {
  Payment: "payment",
  Refund: "refund",
  Fee: "fee",
  Interest: "interest",
 ...
 * If the transaction is a debt/loan account transaction, the type of transaction
 */
export type TransactionSummaryBaseDebtTransactionType = ClosedEnum<
  typeof TransactionSummaryBaseDebtTransactionType
>;
...
/** @internal */
export const TransactionSummaryBaseDebtTransactionType$inboundSchema:
  z.ZodNativeEnum<typeof TransactionSummaryBaseDebtTransactionType> = z
    .nativeEnum(TransactionSummaryBaseDebtTransactionType);

/** @internal */
export const TransactionSummaryBase$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  debt_transaction_type: z.nullable(
    TransactionSummaryBaseDebtTransactionType$inboundSchema,
  ).optional(),
  deleted: z.boolean(),
}).transform((v) => {
  return remap$(v, {
...
export function transactionSummaryBaseFromJSON(
  jsonString: string,
): SafeParseResult<TransactionSummaryBase, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TransactionSummaryBase$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TransactionSummaryBase' from JSON`,
  );
}
