...
export type ScheduledSubTransactionBase = {
  id: string;
...
/** @internal */
export const ScheduledSubTransactionBase$inboundSchema: z.ZodType<
...
export function scheduledSubTransactionBaseFromJSON(
  jsonString: string,
): SafeParseResult<ScheduledSubTransactionBase, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ScheduledSubTransactionBase$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ScheduledSubTransactionBase' from JSON`,
  );
}
