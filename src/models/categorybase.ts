 ...
 */
export const CategoryBaseGoalType = {
  Tb: "TB",
  Tbd: "TBD",
  Mf: "MF",
  Need: "NEED",
 ...
 * The type of goal, if the category has a goal (TB='Target Category Balance', TBD='Target Category Balance by Date', MF='Monthly Funding', NEED='Plan Your Spending')
 */
export type CategoryBaseGoalType = ClosedEnum<typeof CategoryBaseGoalType>;
...
export type CategoryBase = {
   ...
   * The type of goal, if the category has a goal (TB='Target Category Balance', TBD='Target Category Balance by Date', MF='Monthly Funding', NEED='Plan Your Spending')
   */
  goalType?: CategoryBaseGoalType | null | undefined;
  /**
...
/** @internal */
export const CategoryBaseGoalType$inboundSchema: z.ZodNativeEnum<
  typeof CategoryBaseGoalType
> = z.nativeEnum(CategoryBaseGoalType);

/** @internal */
export const CategoryBase$inboundSchema: z.ZodType<
  CategoryBase,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  goal_type: z.nullable(CategoryBaseGoalType$inboundSchema).optional(),
...
export function categoryBaseFromJSON(
  jsonString: string,
): SafeParseResult<CategoryBase, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CategoryBase$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CategoryBase' from JSON`,
  );
}
