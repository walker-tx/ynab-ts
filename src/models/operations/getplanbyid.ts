...
export type GetPlanByIdRequest = {
  /**
...
/** @internal */
export type GetPlanByIdRequest$Outbound = {
  plan_id: string;
  last_knowledge_of_server?: number | undefined;
};

/** @internal */
export const GetPlanByIdRequest$outboundSchema: z.ZodType<
  GetPlanByIdRequest$Outbound,
  z.ZodTypeDef,
  GetPlanByIdRequest
> = z.object({
  planId: z.string(),
...
export function getPlanByIdRequestToJSON(
  getPlanByIdRequest: GetPlanByIdRequest,
): string {
  return JSON.stringify(
    GetPlanByIdRequest$outboundSchema.parse(getPlanByIdRequest),
  );
}
